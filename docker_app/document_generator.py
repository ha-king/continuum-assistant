...
class DocumentGenerator:
    ...
    def create_powerpoint_presentation(self, content, title="Crypto Market Analysis"):
        ...
        try:
            ...
            subtitle_placeholder.text = f"48-Hour Forecast & Analysis\n{datetime.now().strftime('%B %d, %Y')}"
            ...
            for section_title, section_content in sections.items():
                ...
                # Add bullet points
                bullet_points = [line.strip() for line in section_content if line.strip().startswith(('- ', '• '))]
                
                for i, bullet in enumerate(bullet_points[:6]):  # Limit to 6 bullets per slide
            ...
            takeaways = [
                ...
                "Stay updated on market catalysts"
            ]
